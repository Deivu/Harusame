            ...
            switch (msg.op) {
                ...
                case 1: {
                    ...
                    this.data = {
                        ...
                        artists: d.song.artists ? d.song.artists.map((a) => ({ ...a, image: a.image ? `https://cdn.listen.moe/artists/${a.image}` : defaultImage })) : [],
                        requester: d.requester ? d.requester.displayName : 'none',
                        albums: d.song.albums ? d.song.albums.map((a) => ({ ...a, image: a.image ? `https://cdn.listen.moe/covers/${a.image}` : defaultImage })) : [],
